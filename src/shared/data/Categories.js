import cardiologyImage from "../images/cardiology.jpg";
import dermatologyImage from "../images/dermatology.jpg";
import orthopedicsImage from "../images/orthopedics.jpg";
import neurologyImage from "../images/neurology.jpg";
import pediatricsImage from "../images/pediatrics.jpg";
import gastroenterologyImage from "../images/gastroenterology.jpg";
...
export const Categories = [
  ...
  },
  {
    ...
    description:
      "Obstetricians and gynecologists (OB/GYNs) specialize in women's reproductive health. They provide prenatal care, manage childbirth, and address a range of gynecological issues such as fertility, menstrual disorders, and gynecological cancers.",
    width: "40%",
  },
];
